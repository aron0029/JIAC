class Tillsalu extends Base {
  ...
  <form>
    ...
    <div class="form-group mt-3">
      ...
      <div class="row">
        <div class="col-6">Jag är till vänster</div>
        <div class="col-6">Jag är till höger</div>
      </div>
...
<input type="range" class="form-control-range" id="formControlRange" input="changeMinKvm"
  value="${this.anvandarensVal.minKvm}" min="100000" max="100000000" step="50000">
<br><br>
...
HÖGSTA KVM ${this.currencyFormatter.format(this.anvandarensVal.minKvm)}
<input type="range" class="form-control-range" id="formControlRange" input="changeMaxKvm"
  value="${this.anvandarensVal.maxKvm}" min="100000" max="100000000" step="50000">
</form>
...
<div class="row">
  ...
  <div class="card" style="width: 50rem;">
    <div class="card" style="hight: 220rem;">
